                ...
                <div className={`h-20 flex items-center border-b border-white/[0.06] px-5 ${sidebarCollapsed ? 'justify-center' : ''}`}>
                    {sidebarCollapsed ? (
                        <button onClick={() => setSidebarCollapsed(false)} className="p-2 hover:bg-white/5 rounded-xl transition-colors">
                            <Image src="/logos/icon.png" alt="Agentic Finance" width={32} height={32} className="w-8 h-8 object-contain" />
                        </button>
                    ) : (
                        <div className="flex items-center gap-3 w-full">
                            <Image src="/logo.png" alt="" width={32} height={32} className="h-8 w-8 object-contain" /><span className="text-lg font-extrabold text-white tracking-tight" style={{ fontFamily: "'Bricolage Grotesque', system-ui, sans-serif" }}>Agentic Finance</span>
