 ...
 *
 * Returns PayPol's Agent Card following the A2A specification.
 * External AI agents can discover PayPol's 32 on-chain agents,
...
const AGENT_MANIFESTS = [
  ...
  { id: 'tempo-benchmark',      name: 'Tempo Benchmark',        description: 'Gas cost benchmarking comparing Tempo L1 vs Ethereum mainnet for all PayPol operations.',                                                                    category: 'analytics',    price: 2,  capabilities: ['gas-benchmark', 'cost-analysis', 'chain-comparison'] },
  // Wave 1
  ...
  { id: 'allowance-manager',    name: 'Allowance Manager',      description: 'ERC20 approval management for all PayPol contracts. Set, check, and revoke token allowances.',                                                                category: 'defi',         price: 2,  capabilities: ['erc20-approve', 'allowance-check', 'allowance-revoke'] },
  ...
  { id: 'fee-collector',        name: 'Fee Collector',          description: 'Platform fee collection from NexusV2, StreamV1, and other PayPol contracts.',                                                                                 category: 'treasury',     price: 3,  capabilities: ['fee-collection', 'platform-revenue'] },
  ...
  { id: 'treasury-manager',     name: 'Treasury Manager',       description: 'All-in-one treasury overview — balances, deposits, fees, escrow states across all PayPol contracts.',                                                          category: 'treasury',     price: 3,  capabilities: ['treasury-overview', 'contract-balances', 'analytics'] },
  ...
  { id: 'gas-profiler',         name: 'Gas Profiler',           description: 'Per-operation gas cost profiling on Tempo L1 for all PayPol contract operations.',                                                                             category: 'analytics',    price: 2,  capabilities: ['gas-profile', 'cost-per-operation', 'optimization'] },
  ...
  { id: 'contract-reader',      name: 'Contract Reader',        description: 'Comprehensive read of all PayPol contract states — NexusV2, ShieldVault, Stream, Multisend.',                                                                  category: 'analytics',    price: 2,  capabilities: ['contract-read', 'state-inspection', 'comprehensive'] },
