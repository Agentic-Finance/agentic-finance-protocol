            ...
            <div className="min-h-screen bg-[#111B2E] flex flex-col items-center justify-center relative overflow-hidden font-sans">
                ...
                <div className="relative z-10 w-full max-w-2xl px-4 sm:px-8">
                    <div className="text-center mb-8 sm:mb-10">
                        <span className="block text-3xl font-extrabold text-white tracking-tight mb-6 drop-shadow-[0_0_25px_rgba(255,255,255,0.2)]" style={{ fontFamily: "'Bricolage Grotesque', system-ui, sans-serif" }}>Agentic Finance</span>
