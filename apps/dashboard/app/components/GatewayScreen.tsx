            ...
            <div className="min-h-screen bg-[#111B2E] flex flex-col items-center justify-center relative overflow-hidden font-sans">
                ...
                <div className="relative z-10 w-full max-w-2xl px-4 sm:px-8">
                    <div className="text-center mb-8 sm:mb-10">
                        <Image src="/logo.png" alt="Agentic Finance" width={192} height={48} className="h-12 w-auto object-contain mx-auto mb-6 drop-shadow-[0_0_25px_rgba(255,255,255,0.2)]" priority />
            ...
            <div className="min-h-screen bg-[#111B2E] flex flex-col items-center justify-center relative overflow-hidden font-sans">
                ...
                <div className="relative z-10 text-center w-full px-4 sm:px-8">
                    <div className="flex justify-center items-center mb-8 animate-in slide-in-from-bottom-4 duration-700">
                        <Image src="/logo.png" alt="Agentic Finance" width={448} height={112} className="h-20 md:h-28 w-auto object-contain drop-shadow-[0_0_50px_rgba(255,255,255,0.4)] mx-auto" priority />
                    </div>
