                ...
                <div className="relative z-10 w-full max-w-2xl px-4 sm:px-8">
                    <div className="text-center mb-8 sm:mb-10">
                        <div className="flex items-center justify-center gap-3 mb-6">
                            <Image src="/logo.png" alt="" width={48} height={48} className="h-12 w-12 object-contain drop-shadow-[0_0_25px_rgba(255,255,255,0.2)]" style={{ mixBlendMode: 'screen' }} priority />
            ...
            <div className="min-h-screen bg-[#111B2E] flex flex-col items-center justify-center relative overflow-hidden font-sans">
                ...
                <div className="relative z-10 text-center w-full px-4 sm:px-8">
                    <div className="flex flex-col items-center mb-8 animate-in slide-in-from-bottom-4 duration-700">
                        <Image src="/logo.png" alt="" width={120} height={120} className="h-24 md:h-32 w-auto object-contain mb-6 drop-shadow-[0_0_50px_rgba(255,255,255,0.4)]" style={{ mixBlendMode: 'screen' }} priority />
