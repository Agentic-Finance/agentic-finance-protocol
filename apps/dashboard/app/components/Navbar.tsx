                ...
                <div className="max-w-[1440px] mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                        ...
                        <Link href="/" className="flex items-center gap-2.5 group">
                            <Image src="/logos/horizontal-dark.svg" alt="Agentic Finance" width={140} height={36} className="h-7 w-auto object-contain drop-shadow-[0_0_12px_rgba(255,255,255,0.1)] group-hover:drop-shadow-[0_0_18px_rgba(255,255,255,0.2)] transition-all" priority />
                        </Link>
