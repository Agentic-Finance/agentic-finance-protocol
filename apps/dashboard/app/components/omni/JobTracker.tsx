                        ...
                        <div className="bg-indigo-500/5 border border-indigo-500/10 rounded-xl p-4 animate-in fade-in duration-500">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        onClick={onCancel}
                                        className="px-3 py-1.5 bg-white/[0.03] hover:bg-rose-500/10 border border-white/[0.10] hover:border-rose-500/20 text-slate-500 hover:text-rose-400 text-[10px] font-semibold rounded-lg transition-all flex items-center gap-1"
                                    >
        ...
        <div className="bg-emerald-500/5 border border-emerald-500/15 rounded-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="p-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={onReset}
                        className="px-4 py-2 bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.10] text-slate-400 text-[11px] font-semibold rounded-lg transition-all"
                    >
                        New Task
                    </button>
                    <button
                        onClick={() => setShowRaw(!showRaw)}
                        className="px-4 py-2 bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.10] text-slate-400 text-[11px] font-semibold rounded-lg transition-all flex items-center gap-1"
                    >
        ...
        <div className="bg-rose-500/5 border border-rose-500/15 rounded-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="p-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={onReset}
                        className="px-4 py-2 bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.10] text-slate-400 text-[11px] font-semibold rounded-lg transition-all flex items-center gap-1.5"
                    >
