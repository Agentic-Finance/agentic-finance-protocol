...
const LiveDashboard = dynamic(() => import('../components/LiveDashboard'), {
  ssr: false,
  loading: () => <TabSkeleton label="Connecting to Nerve Center..." />,
});

const WarRoomShell = dynamic(() => import('../components/warroom/WarRoomShell'), {
  ssr: false,
  loading: () => <TabSkeleton label="Loading 3D Globe..." />,
});
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 pt-5 pb-2">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <h1 className="text-xl sm:text-2xl font-black text-white tracking-tight">Nerve Center</h1>
            <p className="text-[11px] text-slate-500 mt-0.5">Real-time protocol activity & agent economy visualizer</p>
          </div>
        </div>
