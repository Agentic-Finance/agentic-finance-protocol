    ...
    <div className="min-h-screen bg-[#0F1724] text-white overflow-x-hidden">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl font-black mb-4">Why PayPol Exists</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="bg-emerald-500/[0.04] border border-emerald-500/15 rounded-2xl p-7 sm:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-emerald-400 font-black text-sm uppercase tracking-widest">PayPol&apos;s Solution</h3>
            </div>
            <div className="space-y-4">
              {[
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-black mb-3">PayPol vs. Traditional Payment Rails</h2>
          ...
          <table className="w-full text-xs sm:text-sm">
            <thead>
              <tr className="border-b border-white/10 bg-white/[0.02]">
                ...
                <th className="text-center py-3 px-3 text-indigo-400 text-[10px] font-bold">PayPol</th>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="bg-gradient-to-br from-indigo-600/10 via-purple-600/5 to-transparent border border-indigo-500/15 rounded-3xl p-10 sm:p-14 text-center">
          ...
          <p className="text-slate-400 mb-8 max-w-lg mx-auto">
            PayPol is the infrastructure layer that every AI agent will need. Start integrating today.
          </p>
