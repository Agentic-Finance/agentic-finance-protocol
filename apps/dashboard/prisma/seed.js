...
const agents = [
  ...
  { name: "Stream Creator", description: "Creates milestone-based payment streams on Agentic FinanceStreamV1. AI breaks job descriptions into milestones with budgets, then deploys progressive escrow streams on-chain.", category: "streams", skills: '["stream","milestone","progressive-escrow","create","budget","on-chain"]', basePrice: 8, nativeAgentId: "stream-creator", ownerWallet: WALLET, avatarEmoji: "\u{1F4A7}", isVerified: true, totalJobs: 0, successRate: 100, avgRating: 5.0, ratingCount: 0, responseTime: 20 },

  { name: "Stream Manager", description: "Manages Agentic FinanceStreamV1 lifecycle — submit milestones with proof hashes, approve/reject deliverables, cancel streams, check on-chain status. Full stream lifecycle management.", category: "streams", skills: '["stream","milestone","submit","approve","reject","cancel","on-chain"]', basePrice: 5, nativeAgentId: "stream-manager", ownerWallet: WALLET, avatarEmoji: "\u{1F3D7}\uFE0F", isVerified: true, totalJobs: 0, successRate: 100, avgRating: 5.0, ratingCount: 0, responseTime: 12 },
  ...
  { name: "Gas Profiler", description: "Profile gas costs of individual Agentic Finance operations on Tempo L1. Measures real gas usage for transfers, escrows, batch sends, stream operations, and proof commits. Cost optimization tool.", category: "analytics", skills: '["gas","profiler","cost","benchmark","optimization","on-chain"]', basePrice: 3, nativeAgentId: "gas-profiler", ownerWallet: WALLET, avatarEmoji: "\u26FD", isVerified: true, totalJobs: 0, successRate: 100, avgRating: 5.0, ratingCount: 0, responseTime: 25 },

  { name: "Recurring Payment", description: "Set up recurring scheduled payments as multiple payment streams on Agentic FinanceStreamV1. AI parses payment schedules and creates milestone-based streams for each period. On-chain automation.", category: "payments", skills: '["recurring","schedule","stream","subscription","automated","on-chain"]', basePrice: 10, nativeAgentId: "recurring-payment", ownerWallet: WALLET, avatarEmoji: "\u{1F4C5}", isVerified: true, totalJobs: 0, successRate: 100, avgRating: 5.0, ratingCount: 0, responseTime: 25 },
