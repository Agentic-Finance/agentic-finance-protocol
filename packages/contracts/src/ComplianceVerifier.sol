...
contract CompliancePlonkVerifier {
    // Omega
    ...
    uint256 constant Qmx  = 19232775728224133512443376959006951099063183720092011058614525935219076048253;
    uint256 constant Qmy  = 6771351325591889934378037806621105127061684556289705528366644369307113534266;
    uint256 constant Qlx  = 13701035064993189461354671775800768969301793344286458891499685334544089768818;
    uint256 constant Qly  = 13430953147871470298535898849748452075750968945306456582783447685541676487619;
    uint256 constant Qrx  = 10203163733386420421954004082683300972626967549493190983574595069230807661743;
    uint256 constant Qry  = 5679577903588225552322064215141317053654430284499624181333685222561247875288;
    uint256 constant Qox  = 20558848159918082872447739864663741020666375484509488802768288647548269546058;
    uint256 constant Qoy  = 8233606739601322019587896596991950508334889276080252244672742279029927488921;
    uint256 constant Qcx  = 10149631518828298394971989754711439431175050326320941625619875342588378474366;
    uint256 constant Qcy  = 8020484174310622329095797680573080470440686753878798563928404930451983707612;
    uint256 constant S1x  = 10402516243661396487925149786128863083426450334269818182438089759845767448688;
    uint256 constant S1y  = 10254327603756997621246911003050052670454011197696579343128030583319750652002;
    uint256 constant S2x  = 7737883413089725503761095031579429249384451597487045852284610552863297804770;
    uint256 constant S2y  = 1057172659057186264764984464903045329451830169520910555422934497664333636517;
    uint256 constant S3x  = 11681076291858830263951401448478051194813590961622110939714001855571068878789;
    uint256 constant S3y  = 18649678853305377350392188198241469291893784596260209896092714048721504390390;
